var QkEditor = (function () {
  ...
  var showFontColor = function showFontColor(editor, toolbarItem) {
    ...
    toolbarPop.addEventListener('click', function (e) {
      ...
      if (tg.className === 'qk-colorpicker-btn') {
        var _currentColor = toolbarItem.querySelector('#qk-colorpicker-value').value;
        editor.setTextStyle('span', {
          color: _currentColor
        });
        toolbarItem.querySelector('#qk-colorpicker-selected').style.background = _currentColor;
      }
    });
  };
  var showBgColor = function showBgColor(editor, toolbarItem) {
    ...
    toolbarPop.addEventListener('click', function (e) {
      ...
      if (tg.className === 'qk-colorpicker-btn') {
        var _currentColor2 = toolbarItem.querySelector('#qk-colorpicker-value').value;
        editor.setTextStyle('span', {
          background: _currentColor2
        });
        toolbarItem.querySelector('#qk-colorpicker-selected').style.background = _currentColor2;
      }
    });
  };
